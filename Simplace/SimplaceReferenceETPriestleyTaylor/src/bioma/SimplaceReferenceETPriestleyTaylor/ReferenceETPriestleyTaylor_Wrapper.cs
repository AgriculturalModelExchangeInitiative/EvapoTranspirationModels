...
using System.Linq;
using Crop2ML_ReferenceETPriestleyTaylor_.DomainClass;
using Crop2ML_ReferenceETPriestleyTaylor_.Strategies;

namespace Model.Model.ReferenceETPriestleyTaylor_
{
