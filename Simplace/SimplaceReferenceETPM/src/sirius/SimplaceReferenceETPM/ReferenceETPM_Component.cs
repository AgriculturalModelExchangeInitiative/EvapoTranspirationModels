...
{
    public class ReferenceETPM_Component : IStrategySiriusQualityReferenceETPM_
    {
        public ReferenceETPM_Component()
        {
            ...
            pd1.PropertyType = (SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iNetRadiation).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo =(SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iNetRadiation);
            _inputs0_0.Add(pd1);
            ...
            pd2.PropertyType = (SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iActualVapourPressure).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iActualVapourPressure);
            _inputs0_0.Add(pd2);
            ...
            pd3.PropertyType = (SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iTMax).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iTMax);
            _inputs0_0.Add(pd3);
            ...
            pd4.PropertyType = (SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iTMin).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iTMin);
            _inputs0_0.Add(pd4);
            ...
            lAssStrat0_0.Add(typeof(SiriusQualityReferenceETPM_.Strategies.ReferenceETPM).FullName);
        ...
        {
            get { return SiriusQualityReferenceETPM_.Strategies.{'modu': 'ReferenceETPM', 'var': 'cAltitude'}.cAltitudeVarInfo;} 
        }
        ...
        public string TestPostConditions(SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_State s,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_State s1,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_Rate r,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_Auxiliary a,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_Exogenous ex,string callID)
        {
            try
            {
                ...
                string ret = "";
                ret += _ReferenceETPM.TestPostConditions(s, s1, r, a, ex, " strategy SiriusQualityReferenceETPM_.Strategies.ReferenceETPM_");
            ...
            {
                string msg = "Component SiriusQuality.ReferenceETPM_, " + this.GetType().Name + ": Unhandled exception running post-condition test. ";
        ...
        public string TestPreConditions(SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_State s,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_State s1,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_Rate r,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_Auxiliary a,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_Exogenous ex,string callID)
        {
            try
            {
                ...
                ConditionsCollection prc = new ConditionsCollection();
                Preconditions pre = new Preconditions(); 
                RangeBasedCondition r1 = new RangeBasedCondition(SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iNetRadiation);
                if(r1.ApplicableVarInfoValueTypes.Contains( SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iNetRadiation.ValueType)){prc.AddCondition(r1);}
                RangeBasedCondition r2 = new RangeBasedCondition(SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iActualVapourPressure);
                if(r2.ApplicableVarInfoValueTypes.Contains( SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iActualVapourPressure.ValueType)){prc.AddCondition(r2);}
                RangeBasedCondition r3 = new RangeBasedCondition(SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iTMax);
                if(r3.ApplicableVarInfoValueTypes.Contains( SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iTMax.ValueType)){prc.AddCondition(r3);}
                RangeBasedCondition r4 = new RangeBasedCondition(SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iTMin);
                if(r4.ApplicableVarInfoValueTypes.Contains( SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_ExogenousVarInfo.iTMin.ValueType)){prc.AddCondition(r4);}
                ...
                string ret = "";
                ret += _ReferenceETPM.TestPreConditions(s, s1, r, a, ex, " strategy SiriusQualityReferenceETPM_.Strategies.ReferenceETPM_");
            ...
            {
                string msg = "Component SiriusQuality.ReferenceETPM_, " + this.GetType().Name + ": Unhandled exception running pre-condition test. ";
                throw new Exception(msg, exception);
            }
        }
        ...
        private void CalculateModel(SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_State s,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_State s1,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_Rate r,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_Auxiliary a,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_Exogenous ex)
        {
        ...
        private void EstimateOfAssociatedClasses(SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_State s,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_State s1,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_Rate r,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_Auxiliary a,SiriusQualityReferenceETPM_.DomainClass.ReferenceETPM_Exogenous ex)
        {
