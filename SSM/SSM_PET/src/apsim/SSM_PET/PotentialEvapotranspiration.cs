...
public class PotentialEvapotranspiration
{
    ...
    [Description("Extinction coefficient for canopy")] 
    [Units("-")] 
    //[Crop2ML(datatype="DOUBLE", min=0.1, max=2., default=0.5, parametercategory=constant, inputtype="parameter")] 
    public double ket
    {
    ...
    /// <summary>
    /// Algorithm of the PotentialEvapotranspiration component
    /// </summary>
