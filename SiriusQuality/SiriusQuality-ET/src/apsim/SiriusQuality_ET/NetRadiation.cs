...
public class NetRadiation
{
    ...
    [Description("albedo Coefficient")] 
    [Units("")] 
    //[Crop2ML(datatype="DOUBLE", min=0, max=1, default=0.23, parametercategory=constant, inputtype="parameter")] 
    ...
    [Description("plant cover factor")] 
    [Units("")] 
    //[Crop2ML(datatype="DOUBLE", min=0, max=100, default=0.9983, parametercategory=species, inputtype="parameter")] 
    public double tau
    {
    ...
    [Description("elevation")] 
    [Units("m")] 
    //[Crop2ML(datatype="DOUBLE", min=500, max=10000, default=0, parametercategory=constant, inputtype="parameter")] 
    ...
    [Description("stefan Boltzman constant")] 
    [Units("")] 
    //[Crop2ML(datatype="DOUBLE", min=0, max=1, default=4.903E-09, parametercategory=constant, inputtype="parameter")] 
    ...
    /// <summary>
    /// Algorithm of the NetRadiation component
    /// </summary>
