...
namespace EnergyBalanceComposite.DomainClass
                                {
                                    public class EnergyBalanceCompositeAuxiliaryVarInfo : IVarInfoClass
                                    {
                                        ...
                                        static EnergyBalanceCompositeAuxiliaryVarInfo()
                                        {
                                            EnergyBalanceCompositeAuxiliaryVarInfo.DescribeVariables();
                                        }

                                        public virtual string Description
                                        {
                                            get { return "EnergyBalanceCompositeAuxiliary Domain class of the component";}
                                        }
                                        ...
                                        {
                                            get { return "EnergyBalanceCompositeAuxiliary";}
                                        }
