...
double PriestlyTaylor::getlambdaV() { return this->lambdaV; }
...
void PriestlyTaylor::setlambdaV(double _lambdaV) { this->lambdaV = _lambdaV; }
...
void PriestlyTaylor::Calculate_Model(PotentialET_PenmanState &s, PotentialET_PenmanState &s1, PotentialET_PenmanRate &r, PotentialET_PenmanAuxiliary &a, PotentialET_PenmanExogenous &ex)
{
    ...
    evapoTranspirationPriestlyTaylor = std::max(Alpha * hslope * (netRadiation / lambdaV * 1000.00) * a_G_Rn / (hslope + psychrometricConstant), 0.00);
