...
void Penman::Calculate_Model(PotentialET_PenmanState &s, PotentialET_PenmanState &s1, PotentialET_PenmanRate &r, PotentialET_PenmanAuxiliary &a, PotentialET_PenmanExogenous &ex)
{
    ...
    double conductance = a.getconductance();
