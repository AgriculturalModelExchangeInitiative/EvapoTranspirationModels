package net.simplace.sim.components.SiriusQuality-Penman;
import  java.io.*;
import  java.util.*;
...
public class Penman extends FWSimComponent
{
    ...
    public HashMap<String, FWSimVariable<?>> createVariables()
    {
        ...
        addVariable(FWSimVariable.createSimVariable("conductance", "conductance", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"m d-1", 0.0, 10000.0, 598.685, this));
        addVariable(FWSimVariable.createSimVariable("evapoTranspirationPenman", "evapoTranspiration of Penman Monteith", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"g m-2 d-1", 0.0, 5000.0, null, this));
