...
public class Penman
{
    ...
    [Description("Specific heat capacity of dry air")] 
    [Units("")] 
    //[Crop2ML(datatype="DOUBLE", min=0.0, max=1.0, default=0.00101, parametercategory=constant, inputtype="parameter")] 
    ...
    [Description("Density of air")] 
    [Units("")] 
    //[Crop2ML(datatype="DOUBLE", min=null, max=null, default=1.225, parametercategory=constant, inputtype="parameter")] 
