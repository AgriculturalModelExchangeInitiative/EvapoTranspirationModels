...
# -*- coding: latin-1 -*-
# This file has been generated at Wed Sep 16 11:28:32 2026

from openalea.core import *


__name__ = 'amei.siriusquality_energybalance.potentialet_penman'
...
__icon__ = ''
__alias__ = ['PotentialET_Penman']


__all__ = ['priestlytaylor_model_priestlytaylor', 'penman_model_penman']
...
penman_model_penman = Factory(name='Penman',
                ...
                inputs=[{'name': 'VPDair', 'interface': IFloat(min=0, max=1000, step=1.000000), 'value': 2.19}, {'name': 'specificHeatCapacityAir', 'interface': IFloat(min=0, max=1, step=1.000000), 'value': 0.00101}, {'name': 'psychrometricConstant', 'interface': IFloat(min=0, max=1, step=1.000000), 'value': 0.66}, {'name': 'rhoDensityAir', 'interface': IFloat, 'value': 1.225}, {'name': 'Alpha', 'interface': IFloat(min=0, max=100, step=1.000000), 'value': 1.5}, {'name': 'evapoTranspirationPriestlyTaylor', 'interface': IFloat(min=0, max=10000, step=1.000000), 'value': 449.367}, {'name': 'lambdaV', 'interface': IFloat(min=0, max=10, step=1.000000), 'value': 2.454}, {'name': 'hslope', 'interface': IFloat(min=0, max=1000, step=1.000000), 'value': 0.584}, {'name': 'conductance', 'interface': IFloat(min=0, max=10000, step=1.000000), 'value': 598.685}],
