...
{
    public class PriestlyTaylor : IStrategyPotentialET_Penman
    {
        public PriestlyTaylor()
        {
            ...
            pd4.DomainClassType = typeof(PotentialET_Penman.DomainClass.PotentialET_PenmanRate);
            pd4.PropertyName = "evapoTranspirationPriestlyTaylor";
            pd4.PropertyType = (PotentialET_Penman.DomainClass.PotentialET_PenmanRateVarInfo.evapoTranspirationPriestlyTaylor).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(PotentialET_Penman.DomainClass.PotentialET_PenmanRateVarInfo.evapoTranspirationPriestlyTaylor);
            _outputs0_0.Add(pd4);
        ...
        public string TestPostConditions(PotentialET_Penman.DomainClass.PotentialET_PenmanState s,PotentialET_Penman.DomainClass.PotentialET_PenmanState s1,PotentialET_Penman.DomainClass.PotentialET_PenmanRate r,PotentialET_Penman.DomainClass.PotentialET_PenmanAuxiliary a,PotentialET_Penman.DomainClass.PotentialET_PenmanExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r8 = new RangeBasedCondition(PotentialET_Penman.DomainClass.PotentialET_PenmanRateVarInfo.evapoTranspirationPriestlyTaylor);
                if(r8.ApplicableVarInfoValueTypes.Contains( PotentialET_Penman.DomainClass.PotentialET_PenmanRateVarInfo.evapoTranspirationPriestlyTaylor.ValueType)){prc.AddCondition(r8);}
