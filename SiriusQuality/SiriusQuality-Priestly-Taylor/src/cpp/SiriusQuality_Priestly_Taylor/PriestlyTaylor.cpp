...
void PriestlyTaylor::Calculate_Model(PotentialET_PTState &s, PotentialET_PTState &s1, PotentialET_PTRate &r, PotentialET_PTAuxiliary &a, PotentialET_PTExogenous &ex)
{
