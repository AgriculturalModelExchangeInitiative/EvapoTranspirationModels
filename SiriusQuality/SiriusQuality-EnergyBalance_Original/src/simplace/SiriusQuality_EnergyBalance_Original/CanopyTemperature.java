...
public class CanopyTemperature extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("specificHeatCapacityAir", "Specific heat capacity of dry air", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"MJ/kg/degC", 0.0, 0.0, 0.00101, this));
        ...
        addVariable(FWSimVariable.createSimVariable("cropHeatFlux", "Crop heat flux", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"g/m**2/d", 0.0, 10000.0, 447.912, this));
        addVariable(FWSimVariable.createSimVariable("lambdaV", "latent heat of vaporization of water", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"MJ/kg", 0.0, 10.0, 2.454, this));
        ...
        addVariable(FWSimVariable.createSimVariable("rhoDensityAir", "Density of air", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"kg/m**3", 0.0, 0.0, 1.225, this));
        addVariable(FWSimVariable.createSimVariable("conductance", "the boundary layer conductance", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"m/d", 0.0, 10000.0, 598.685, this));
        addVariable(FWSimVariable.createSimVariable("maxCanopyTemperature", "maximal Canopy Temperature", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"degC", 30.0, 45.0, 0.0, this));
        addVariable(FWSimVariable.createSimVariable("minCanopyTemperature", "minimal Canopy Temperature", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"degC", 30.0, 45.0, 0.0, this));
