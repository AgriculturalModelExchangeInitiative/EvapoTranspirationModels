...
public class NetRadiation extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("albedoCoefficient", "albedo Coefficient", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0.0, 1.0, 0.23, this));
        addVariable(FWSimVariable.createSimVariable("maxTair", "maximum air Temperature", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"degC", 30.0, 45.0, 7.2, this));
        addVariable(FWSimVariable.createSimVariable("minTair", "minimum air temperature", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"degC", 30.0, 45.0, 0.7, this));
        addVariable(FWSimVariable.createSimVariable("vaporPressure", "vapor Pressure", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"hPa", 0.0, 1000.0, 6.1, this));
        ...
        addVariable(FWSimVariable.createSimVariable("extraSolarRadiation", "extra Solar Radiation", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"MJ m2 d-1", 0.0, 1000.0, 11.7, this));
        ...
        addVariable(FWSimVariable.createSimVariable("tau", "plant cover factor", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0.0, 100.0, 0.9983, this));
        addVariable(FWSimVariable.createSimVariable("elevation", "elevation", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"m", 500.0, 10000.0, 0.0, this));
        addVariable(FWSimVariable.createSimVariable("stefanBoltzman", "stefan Boltzman constant", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0.0, 1.0, 4.903e-09, this));
        addVariable(FWSimVariable.createSimVariable("albedoCoefficientCan", "albedo Coefficient", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0.0, 1.0, 0.23, this));
        addVariable(FWSimVariable.createSimVariable("netRadiation", "net radiation", DATA_TYPE.DOUBLE, CONTENT_TYPE.out,"MJ m-2 d-1", 0.0, 5000.0, 0.0, this));
        addVariable(FWSimVariable.createSimVariable("netOutGoingLongWaveRadiation", "net OutGoing Long Wave Radiation", DATA_TYPE.DOUBLE, CONTENT_TYPE.out,"g m-2 d-1", 0.0, 5000.0, 0.0, this));
