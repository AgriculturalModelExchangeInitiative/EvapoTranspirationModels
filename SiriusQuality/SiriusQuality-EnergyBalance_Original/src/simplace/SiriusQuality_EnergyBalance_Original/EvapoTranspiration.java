...
public class EvapoTranspiration extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("evapoTranspirationPenman", "evapoTranspiration of Penman", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"mm", 0.0, 10000.0, 830.958, this));
        ...
        addVariable(FWSimVariable.createSimVariable("evapoTranspirationPriestlyTaylor", "evapoTranspiration of Priestly Taylor", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"mm", 0.0, 10000.0, 449.367, this));
        addVariable(FWSimVariable.createSimVariable("evapoTranspiration", "evapoTranspiration", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"mm", 0.0, 10000.0, 0.0, this));
    ...
    protected void process()
    {
        ...
        Integer t_isWindVpDefined = isWindVpDefined.getValue();
        double t_evapoTranspirationPriestlyTaylor = evapoTranspirationPriestlyTaylor.getValue();
        double t_evapoTranspiration = evapoTranspiration.getDefault();
