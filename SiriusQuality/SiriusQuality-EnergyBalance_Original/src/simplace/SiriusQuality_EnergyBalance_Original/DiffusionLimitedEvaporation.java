...
public class DiffusionLimitedEvaporation extends FWSimComponent
{
    ...
    public HashMap<String, FWSimVariable<?>> createVariables()
    {
        ...
        addVariable(FWSimVariable.createSimVariable("soilDiffusionConstant", "soil Diffusion Constant", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0.0, 10.0, 4.2, this));
        addVariable(FWSimVariable.createSimVariable("deficitOnTopLayers", "deficit On TopLayers", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"g m-2 d-1", 0.0, 10000.0, 5341.0, this));
        addVariable(FWSimVariable.createSimVariable("diffusionLimitedEvaporation", "the evaporation from the diffusion limited soil", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"g m-2 d-1", 0.0, 5000.0, 0.0, this));
