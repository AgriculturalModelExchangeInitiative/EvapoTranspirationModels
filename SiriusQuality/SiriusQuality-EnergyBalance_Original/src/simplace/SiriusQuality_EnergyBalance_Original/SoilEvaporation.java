...
public class SoilEvaporation extends FWSimComponent
{
    ...
    public HashMap<String, FWSimVariable<?>> createVariables()
    {
        ...
        addVariable(FWSimVariable.createSimVariable("energyLimitedEvaporation", "energy Limited Evaporation", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"g m-2 d-1", 0.0, 1000.0, 448.24, this));
        addVariable(FWSimVariable.createSimVariable("diffusionLimitedEvaporation", "diffusion Limited Evaporation", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"g m-2 d-1", 0.0, 10000.0, 6605.505, this));
        addVariable(FWSimVariable.createSimVariable("soilEvaporation", "soil Evaporation", DATA_TYPE.DOUBLE, CONTENT_TYPE.out,"g m-2 d-1", 0.0, 5000.0, 0.0, this));
