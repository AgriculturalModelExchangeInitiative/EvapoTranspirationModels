...
public class Conductance extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("d", "corresponding to 2/3. This is multiplied to the crop heigth for calculating the zero plane displacement height, FAO", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"dimensionless", 0.0, 1.0, 0.67, this));
        addVariable(FWSimVariable.createSimVariable("heightWeatherMeasurements", "reference height of wind and humidity measurements", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"m", 0.0, 10.0, 2.0, this));
        addVariable(FWSimVariable.createSimVariable("plantHeight", "plant Height", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"mm", 0.0, 1000.0, 0.0, this));
        addVariable(FWSimVariable.createSimVariable("zh", "roughness length governing transfer of heat and vapour, FAO", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"m", 0.0, 1.0, 0.013, this));
        addVariable(FWSimVariable.createSimVariable("zm", "roughness length governing momentum transfer, FAO", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"m", 0.0, 1.0, 0.13, this));
        addVariable(FWSimVariable.createSimVariable("vonKarman", "von Karman constant", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"dimensionless", 0.0, 1.0, 0.42, this));
        ...
        addVariable(FWSimVariable.createSimVariable("wind", "wind", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"m/d", 0.0, 1000000.0, 124000.0, this));
        addVariable(FWSimVariable.createSimVariable("conductance", "the boundary layer conductance", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"m/d", 0.0, 10000.0, 0.0, this));
