...
public class CropHeatFlux extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("netRadiationEquivalentEvaporation", "net Radiation Equivalent Evaporation", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"g m-2 d-1", 0.0, 10000.0, 638.142, this));
        addVariable(FWSimVariable.createSimVariable("soilHeatFlux", "soil Heat Flux", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"g m-2 d-1", 0.0, 1000.0, 188.817, this));
        addVariable(FWSimVariable.createSimVariable("potentialTranspiration", "potential Transpiration", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"g m-2 d-1", 0.0, 1000.0, 1.413, this));
        ...
        addVariable(FWSimVariable.createSimVariable("cropHeatFlux", "crop Heat Flux", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"g m-2 d-1", 0.0, 10000.0, 0.0, this));
