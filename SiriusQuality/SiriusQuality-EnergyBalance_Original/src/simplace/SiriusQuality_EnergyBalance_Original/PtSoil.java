...
public class PtSoil extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("tauAlpha", "Fraction of the total net radiation exchanged at the soil surface when AlpaE = 1", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0.0, 1.0, 0.3, this));
        ...
        addVariable(FWSimVariable.createSimVariable("evapoTranspirationPriestlyTaylor", "evapoTranspiration Priestly Taylor", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"g m-2 d-1", 0.0, 1000.0, 120.0, this));
        addVariable(FWSimVariable.createSimVariable("tau", "soil cover factor", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"", 0.0, 1.0, 120.0, this));
        ...
        addVariable(FWSimVariable.createSimVariable("energyLimitedEvaporation", "energy Limited Evaporation", DATA_TYPE.DOUBLE, CONTENT_TYPE.out,"g m-2 d-1", 0.0, 5000.0, 0.0, this));
