...
public class PotentialTranspiration extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("evapoTranspiration", "evapoTranspiration", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"mm", 0.0, 10000.0, 830.958, this));
        addVariable(FWSimVariable.createSimVariable("tau", "plant cover factor", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0.0, 1.0, 0.9983, this));
        addVariable(FWSimVariable.createSimVariable("potentialTranspiration", "potential Transpiration", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"g m-2 d-1", 0.0, 10000.0, 0.0, this));
