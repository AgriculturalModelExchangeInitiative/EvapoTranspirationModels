...
public class Penman extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("VPDair", "vapour pressure density", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"hPa", 0.0, 1000.0, 2.19, this));
        addVariable(FWSimVariable.createSimVariable("specificHeatCapacityAir", "Specific heat capacity of dry air", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0.0, 1.0, 0.00101, this));
        ...
        addVariable(FWSimVariable.createSimVariable("rhoDensityAir", "Density of air", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0.0, 0.0, 1.225, this));
        ...
        addVariable(FWSimVariable.createSimVariable("evapoTranspirationPriestlyTaylor", "evapoTranspiration of Priestly Taylor", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"g m-2 d-1", 0.0, 10000.0, 449.367, this));
        addVariable(FWSimVariable.createSimVariable("lambdaV", "latent heat of vaporization of water", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0.0, 10.0, 2.454, this));
        ...
        addVariable(FWSimVariable.createSimVariable("conductance", "conductance", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"m d-1", 0.0, 10000.0, 598.685, this));
        addVariable(FWSimVariable.createSimVariable("evapoTranspirationPenman", "evapoTranspiration of Penman Monteith", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"g m-2 d-1", 0.0, 5000.0, 0.0, this));
